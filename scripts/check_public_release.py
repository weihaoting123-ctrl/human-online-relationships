...
SYNTHETIC_ALLOWLIST = {
    ...
    ("tests/test_copilot_live.py", "EMAIL_ADDRESS"): frozenset({"test" + "@" + "example.com"}),
    ("tests/test_copilot_live_read.py", "WECHAT_ACCOUNT"): frozenset({"wxid_" + "synthetic_self_ab12", "wxid_" + "synthetic_peer"}),
