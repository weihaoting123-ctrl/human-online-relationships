...
2026-09-06 新一轮[项目解构](docs/project-decomposition.md)与[需求池 R1](BACKLOG.md)已整理：建议先以 v0.1.1 修复首次导入和导航闭环，再分批安排 UI、来源适配、任务状态和操作系统兼容。该方案尚待范围确认，不自动改动下方既有里程碑、待办状态或发布标签。
